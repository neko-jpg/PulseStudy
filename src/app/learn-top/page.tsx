...
export default function LearnTopPage() {
  const startLearning = (moduleId: string) => {
    alert(`「${moduleId}」の学習を開始します`);
    // In a real app, you would navigate to the specific module
  };

  const openSubject = (subject: string) => {
    alert(`「${subject}」の単元一覧を表示します`);
    // In a real app, you would navigate to the subject details page
  };

  const setLearningMode = (mode: string) => {
    console.log(`学習モードを設定: ${mode}`);
    // In a real app, you would set the learning mode
  };
        ...
        <div className="container-inner">
          <div className="quick-access">
            <div
              ...
              onClick={() => handleQuickAction('5分学習')}
            >
              <div className="quick-icon">
                <Zap />
              </div>
              <div className="quick-name">5分学習</div>
              <div className="quick-desc">短時間で集中</div>
            </div>
            <div
              className="quick-item"
              onClick={() => handleQuickAction('苦手克服')}
            >
              <div className="quick-icon">
                <Target />
              </div>
              <div className="quick-name">苦手克服</div>
              <div className="quick-desc">弱点を重点的</div>
            </div>
            <div
              className="quick-item"
              onClick={() => handleQuickAction('テスト対策')}
            >
              <div className="quick-icon">
                <TestTube2 />
              </div>
            ...
            <div className="recommended-cards">
              <div className="recommended-card">
                ...
                <button
                  ...
                  onClick={() => startLearning('math-graph')}
                >
                  開始
                </button>
              </div>
              <div className="recommended-card">
                ...
                <div className="card-title">不定詞の使い分けマスター</div>
                <div className="card-meta">
                  <div className="card-duration">⏱️ 5分</div>
                ...
                <button
                  className="card-button"
                  onClick={() => startLearning('english-infinitive')}
                >
                  開始
                </button>
              </div>
            ...
            <div className="weakness-list">
              <div className="weakness-item">
                ...
                <div className="weakness-info">
                  ...
                  <div className="weakness-desc">
                    正答率: 45% • 最後の学習: 3日前
                  </div>
                </div>
                <button
                  className="weakness-action"
                  onClick={() => startLearning('trigonometry')}
                >
                  強化
                </button>
              </div>
              <div className="weakness-item">
                ...
                <button
                  className="weakness-action"
                  onClick={() => startLearning('relative-pronoun')}
                >
                  強化
                </button>
              </div>
